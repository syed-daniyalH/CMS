...
// ---------- Main ----------
export const SaleAgreementHtml = (
  itemStr: string | null,
...
<style>
  ...
  *{ box-sizing:border-box; -webkit-print-color-adjust:exact; print-color-adjust:exact; }
  ...
  .section .head { font-weight:700; text-decoration:none; padding:6px 6px; background:#f6f7f9;text-align:center; }
  .w25 { width:25%; }
  .muted { color:#666; }
...
<body>
  ...
  <div class="hdr">
    ...
    <div class="title">Sale/ INSTALLMENT SCHEDULE</div>
  </div>
  ...
  <tr>
    <td style="font-weight:700;">${getProjectDetail(user?.projectType??1)}</td>
