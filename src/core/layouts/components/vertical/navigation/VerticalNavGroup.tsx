        ...
        >
          <ListItemButton
            ...
            sx={{
              ...
              px: navCollapsed && !navHover ? (collapsedNavWidth - navigationBorderWidth - 22 - 28) / 8 : 1,
              '&:hover': {
          ...
          >
            <ListItemIcon
              sx={{
                ...
                ...(parent && navCollapsed && !navHover ? {} : { mr: 1 }),
            ...
            >
              <UserIcon icon={icon as string} {...(parent ? { fontSize: '0.625rem' } : { fontSize: '1.225rem' } )} />
            </ListItemIcon>
