...
import ChartjsBarChart from 'src/examples/views/charts/chartjs/ChartjsBarChart'
import ChartjsLineChart from 'src/examples/views/charts/chartjs/ChartjsLineChart'
import ChartjsAreaChart from 'src/examples/views/charts/chartjs/ChartjsAreaChart'
import ChartjsRadarChart from 'src/examples/views/charts/chartjs/ChartjsRadarChart'
import ChartjsBubbleChart from 'src/examples/views/charts/chartjs/ChartjsBubbleChart'
import ChartjsScatterChart from 'src/examples/views/charts/chartjs/ChartjsScatterChart'
import ChartjsPolarAreaChart from 'src/examples/views/charts/chartjs/ChartjsPolarAreaChart'
import ChartjsHorizontalBarChart from 'src/examples/views/charts/chartjs/ChartjsHorizontalBarChart'
