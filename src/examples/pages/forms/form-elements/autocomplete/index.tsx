...
import AutocompleteProps from 'src/examples/views/forms/form-elements/autocomplete/AutocompleteProps'
import AutocompleteCustom from 'src/examples/views/forms/form-elements/autocomplete/AutocompleteCustom'
import AutocompleteCountry from 'src/examples/views/forms/form-elements/autocomplete/AutocompleteCountry'
import AutocompleteGrouped from 'src/examples/views/forms/form-elements/autocomplete/AutocompleteGrouped'
import AutocompleteVariants from 'src/examples/views/forms/form-elements/autocomplete/AutocompleteVariants'
import AutocompleteFreeSolo from 'src/examples/views/forms/form-elements/autocomplete/AutocompleteFreeSolo'
import AutocompleteCreatable from 'src/examples/views/forms/form-elements/autocomplete/AutocompleteCreatable'
import AutocompleteLimitTags from 'src/examples/views/forms/form-elements/autocomplete/AutocompleteLimitTags'
import AutocompleteCheckboxes from 'src/examples/views/forms/form-elements/autocomplete/AutocompleteCheckboxes'
import AutocompleteMediumSize from 'src/examples/views/forms/form-elements/autocomplete/AutocompleteMediumSize'
import AutocompleteCustomInput from 'src/examples/views/forms/form-elements/autocomplete/AutocompleteCustomInput'
import AutocompleteFixedOptions from 'src/examples/views/forms/form-elements/autocomplete/AutocompleteFixedOptions'
import AutocompleteCustomFilter from 'src/examples/views/forms/form-elements/autocomplete/AutocompleteCustomFilter'
import AutocompleteMultipleValues from 'src/examples/views/forms/form-elements/autocomplete/AutocompleteMultipleValues'
import AutocompleteDisabledOptions from 'src/examples/views/forms/form-elements/autocomplete/AutocompleteDisabledOptions'
import AutocompleteAsynchronousRequest from 'src/examples/views/forms/form-elements/autocomplete/AutocompleteAsynchronousRequest'
import AutocompleteControlledUncontrolled from 'src/examples/views/forms/form-elements/autocomplete/AutocompleteControlledUncontrolled'

// ** Source code imports
import * as source from 'src/examples/views/forms/form-elements/autocomplete/AutocompleteSourceCode'
    ...
    <Grid container spacing={6} className='match-height'>
      <Grid item xs={12}>
        <CardSnippet
          title='Custom'
          code={{
            tsx: source.AutocompleteCustomTSXCode,
            jsx: source.AutocompleteCustomJSXCode
          }}
        >
          <Typography>
            Use the <code>CustomTextField</code> component in the <code>renderInput</code> prop with the{' '}
            <code>CustomAutocomplete</code> component to render a custom autocomplete. Use <code>disabled</code> and{' '}
            <code>readOnly</code> props with the <code>CustomAutocomplete</code> component for disabled and read-only
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography>
            Use <code>value</code> prop with <code>CustomAutocomplete</code> component for controlled autocomplete
            input.
          </Typography>
      ...
      <Grid item xs={12}>
        ...
        >
          <Typography>
            Each of the following examples demonstrate one feature of <code>CustomAutocomplete</code> component.
          </Typography>
          <AutocompleteProps />
        </CardSnippet>
      </Grid>
      ...
      <Grid item xs={12} md={6}>
        <CardSnippet
          title='Medium Size'
          code={{
            tsx: source.AutocompleteMediumSizeTSXCode,
            jsx: source.AutocompleteMediumSizeJSXCode
          }}
        >
          <Typography sx={{ mb: 5 }}>
            Use <code>size='medium'</code> prop with the <code>CustomTextField</code> component for medium sized input.
          </Typography>
