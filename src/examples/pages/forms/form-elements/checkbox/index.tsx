...
import CheckboxesBasic from 'src/examples/views/forms/form-elements/checkbox/CheckboxesBasic'
import CheckboxesSizes from 'src/examples/views/forms/form-elements/checkbox/CheckboxesSizes'
import CheckboxesColors from 'src/examples/views/forms/form-elements/checkbox/CheckboxesColors'
import CheckboxesShowError from 'src/examples/views/forms/form-elements/checkbox/CheckboxesShowError'
import CheckboxesCustomized from 'src/examples/views/forms/form-elements/checkbox/CheckboxesCustomized'
import CheckboxesCustomIcons from 'src/examples/views/forms/form-elements/checkbox/CheckboxesCustomIcons'
import CheckboxesLabelPlacement from 'src/examples/views/forms/form-elements/checkbox/CheckboxesLabelPlacement'
import CheckboxesControlledUncontrolled from 'src/examples/views/forms/form-elements/checkbox/CheckboxesControlledUncontrolled'

// ** Source code imports
import * as source from 'src/examples/views/forms/form-elements/checkbox/CheckboxesSourceCode'
