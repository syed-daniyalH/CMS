...
import SliderBasic from 'src/examples/views/forms/form-elements/slider/SliderBasic'
import SliderRange from 'src/examples/views/forms/form-elements/slider/SliderRange'
import SliderSizes from 'src/examples/views/forms/form-elements/slider/SliderSizes'
import SliderColors from 'src/examples/views/forms/form-elements/slider/SliderColors'
import SliderDiscrete from 'src/examples/views/forms/form-elements/slider/SliderDiscrete'
import SliderVertical from 'src/examples/views/forms/form-elements/slider/SliderVertical'
import SliderSmallSteps from 'src/examples/views/forms/form-elements/slider/SliderSmallSteps'
import SliderCustomized from 'src/examples/views/forms/form-elements/slider/SliderCustomized'
import SliderCustomMarks from 'src/examples/views/forms/form-elements/slider/SliderCustomMarks'
import SliderCustomColors from 'src/examples/views/forms/form-elements/slider/SliderCustomColors'
import SliderRemovedTrack from 'src/examples/views/forms/form-elements/slider/SliderRemovedTrack'
import SliderInvertedTrack from 'src/examples/views/forms/form-elements/slider/SliderInvertedTrack'
import SliderMinimumDistance from 'src/examples/views/forms/form-elements/slider/SliderMinimumDistance'
import SliderRestrictedValues from 'src/examples/views/forms/form-elements/slider/SliderRestrictedValues'
import SliderLabelAlwaysVisible from 'src/examples/views/forms/form-elements/slider/SliderLabelAlwaysVisible'
import SliderControlledUncontrolled from 'src/examples/views/forms/form-elements/slider/SliderControlledUncontrolled'

// ** Source code imports
import * as source from 'src/examples/views/forms/form-elements/slider/SliderSourceCode'
