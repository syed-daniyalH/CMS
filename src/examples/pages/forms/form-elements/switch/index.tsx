...
import SwitchesBasic from 'src/examples/views/forms/form-elements/switch/SwitchesBasic'
import SwitchesSizes from 'src/examples/views/forms/form-elements/switch/SwitchesSizes'
import SwitchesColors from 'src/examples/views/forms/form-elements/switch/SwitchesColors'
import SwitchesCustomized from 'src/examples/views/forms/form-elements/switch/SwitchesCustomized'
import SwitchesStandalone from 'src/examples/views/forms/form-elements/switch/SwitchesStandalone'
import SwitchesLabelPlacement from 'src/examples/views/forms/form-elements/switch/SwitchesLabelPlacement'
import SwitchesControlledUncontrolled from 'src/examples/views/forms/form-elements/switch/SwitchesControlledUncontrolled'

// ** Source code imports
import * as source from 'src/examples/views/forms/form-elements/switch/SwitchesSourceCode'
