...
import UsersInvoiceListTable from 'src/examples/views/apps/user/view/UsersInvoiceListTable'
import UsersProjectListTable from 'src/examples/views/apps/user/view/UsersProjectListTable'
