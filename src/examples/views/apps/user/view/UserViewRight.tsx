...
import UserViewBilling from 'src/examples/views/apps/user/view/UserViewBilling'
import UserViewAccount from 'src/examples/views/apps/user/view/UserViewAccount'
import UserViewSecurity from 'src/examples/views/apps/user/view/UserViewSecurity'
import UserViewConnection from 'src/examples/views/apps/user/view/UserViewConnection'
import UserViewNotification from 'src/examples/views/apps/user/view/UserViewNotification'
