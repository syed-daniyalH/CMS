...
// ** Demo Tabs Imports
import TabAccount from 'src/examples/views/pages/account-settings/TabAccount'
import TabBilling from 'src/examples/views/pages/account-settings/TabBilling'
import TabSecurity from 'src/examples/views/pages/account-settings/TabSecurity'
import TabConnections from 'src/examples/views/pages/account-settings/TabConnections'
import TabNotifications from 'src/examples/views/pages/account-settings/TabNotifications'
