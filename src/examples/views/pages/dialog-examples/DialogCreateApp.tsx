...
// ** Tab Content Imports
import DialogTabDetails from 'src/examples/views/pages/dialog-examples/create-app-tabs/DialogTabDetails'
import DialogTabBilling from 'src/examples/views/pages/dialog-examples/create-app-tabs/DialogTabBilling'
import DialogTabDatabase from 'src/examples/views/pages/dialog-examples/create-app-tabs/DialogTabDatabase'
import DialogTabFramework from 'src/examples/views/pages/dialog-examples/create-app-tabs/DialogTabFramework'
