...
} from 'src/mock-db/types'

// ** Icon Imports
import Icon from 'src/core/components/icon'

// ** Demo Components
import Teams from 'src/examples/views/pages/user-profile/teams'
import Profile from 'src/examples/views/pages/user-profile/profile'
import Projects from 'src/examples/views/pages/user-profile/projects'
import Connections from 'src/examples/views/pages/user-profile/connections'
import UserProfileHeader from 'src/examples/views/pages/user-profile/UserProfileHeader'
