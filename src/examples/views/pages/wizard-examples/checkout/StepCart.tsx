        ...
        <StyledList sx={{ mb: 4 }}>
          <ListItem>
            <ListItemAvatar sx={{ display: 'flex', '& img': { my: 5, mx: 8 } }}>
              <img height={100} src='/images/products/google-home.png' alt='Google Home' />
            </ListItemAvatar>
            ...
            <Grid container>
              <Grid item xs={12} md={8}>
                ...
                <Rating name='google-nest-rating' value={4} readOnly sx={{ mb: 5.5 }} />
          ...
          <ListItem>
            <ListItemAvatar sx={{ display: 'flex', '& img': { my: 5, mx: 8 } }}>
              <img height={100} src='/images/products/iphone-11.png' alt='iphone 11' />
            </ListItemAvatar>
            <IconButton size='small' className='remove-item' sx={{ color: 'text.primary' }}>
              <Icon icon='tabler:x' fontSize={20} />
            </IconButton>
