...
// ** Step Components
import StepCart from 'src/examples/views/pages/wizard-examples/checkout/StepCart'
import StepAddress from 'src/examples/views/pages/wizard-examples/checkout/StepAddress'
import StepPayment from 'src/examples/views/pages/wizard-examples/checkout/StepPayment'
import StepConfirmation from 'src/examples/views/pages/wizard-examples/checkout/StepConfirmation'
...
const steps = [
  ...
  },
  {
    title: 'Payment',
    icon: (
      <svg id='wizardPayment' width={60} height={60} viewBox='0 0 58 54' xmlns='http://www.w3.org/2000/svg'>
        <g fillRule='nonzero'>
  ...
  },
  {
    title: 'Confirmations',
    icon: (
      <svg id='wizardConfirm' width={60} height={60} viewBox='0 0 58 54' xmlns='http://www.w3.org/2000/svg'>
        <g fillRule='nonzero'>
