...
import CheckboxesBasic from 'src/views-default/forms/form-elements/checkbox/CheckboxesBasic'
import CheckboxesSizes from 'src/views-default/forms/form-elements/checkbox/CheckboxesSizes'
import CheckboxesColors from 'src/views-default/forms/form-elements/checkbox/CheckboxesColors'
import CheckboxesShowError from 'src/views-default/forms/form-elements/checkbox/CheckboxesShowError'
import CheckboxesCustomized from 'src/views-default/forms/form-elements/checkbox/CheckboxesCustomized'
import CheckboxesCustomIcons from 'src/views-default/forms/form-elements/checkbox/CheckboxesCustomIcons'
import CheckboxesLabelPlacement from 'src/views-default/forms/form-elements/checkbox/CheckboxesLabelPlacement'
import CheckboxesControlledUncontrolled from 'src/views-default/forms/form-elements/checkbox/CheckboxesControlledUncontrolled'

// ** Source code imports
import * as source from 'src/views-default/forms/form-elements/checkbox/CheckboxesSourceCode'
