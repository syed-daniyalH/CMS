...
import TableCustomers from 'src/views/inventory-operations/customers/customers-list/TableCustomers'
...
const CustomersList = () => {
  ...
  const [selectedType, setSelectedType] = useState<string>("All Customers");
  ...
  const onNewClick = (e: any, index: number) => {
    ...
    switch (index) {
      case 0:
        router.push(`/inventory-operations/customers/add-customer`)
        break
      case 1:
  ...
  return (
    <Card sx={{ display: 'flex', flexDirection: 'column', height: '100%', borderRadius: 0 }}>
      ...
      <Divider />
      <TableCustomers toggleFilter={toggleFilter} openFilter={openFilter} />
...
CustomersList.contentHeightFixed = true
