...
import TableProperties from 'src/views/inventory-operations/property/property-list/TableProperties'
...
const PropertiesList = () => {
  ...
  const onNewClick = (e: any, index: number) => {
    ...
    switch (index) {
      case 0:
        router.push(`/inventory-operations/property/add-property`)
        break
      case 1:
  ...
  return (
    <Card sx={{ display: 'flex', flexDirection: 'column', height: '100%', borderRadius: 0 }}>
      ...
      >
        <Typography variant={'h5'}>{t('All Properties')}</Typography>
      ...
      <Divider />
      <TableProperties toggleFilter={toggleFilter} openFilter={openFilter} />
...
PropertiesList.contentHeightFixed = true
