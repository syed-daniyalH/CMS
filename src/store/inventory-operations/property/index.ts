...
export const setLoading = createAsyncThunk('appProperty/setLoading', async (loadingState: LoadingStateParams) => ({ ...loadingState }) as any)

export const getData = createAsyncThunk('appProperty/getData', async (params: PropertyDataParams, { dispatch }) => {
...
export const appProperty = createSlice({
  name: 'appProperty',
  initialState: {
    data: [],
    stats: [],
...
export default appProperty.reducer
