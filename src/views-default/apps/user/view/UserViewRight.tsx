...
import UserViewBilling from 'src/views-default/apps/user/view/UserViewBilling'
import UserViewAccount from 'src/views-default/apps/user/view/UserViewAccount'
import UserViewSecurity from 'src/views-default/apps/user/view/UserViewSecurity'
import UserViewConnection from 'src/views-default/apps/user/view/UserViewConnection'
import UserViewNotification from 'src/views-default/apps/user/view/UserViewNotification'
