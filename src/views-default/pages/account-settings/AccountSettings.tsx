...
// ** Demo Tabs Imports
import TabAccount from 'src/views-default/pages/account-settings/TabAccount'
import TabBilling from 'src/views-default/pages/account-settings/TabBilling'
import TabSecurity from 'src/views-default/pages/account-settings/TabSecurity'
import TabConnections from 'src/views-default/pages/account-settings/TabConnections'
import TabNotifications from 'src/views-default/pages/account-settings/TabNotifications'
