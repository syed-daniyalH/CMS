...
// ** Tab Content Imports
import DialogTabDetails from 'src/views-default/pages/dialog-examples/create-app-tabs/DialogTabDetails'
import DialogTabBilling from 'src/views-default/pages/dialog-examples/create-app-tabs/DialogTabBilling'
import DialogTabDatabase from 'src/views-default/pages/dialog-examples/create-app-tabs/DialogTabDatabase'
import DialogTabFramework from 'src/views-default/pages/dialog-examples/create-app-tabs/DialogTabFramework'
