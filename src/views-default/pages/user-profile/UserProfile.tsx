...
// ** Demo Components
import Teams from 'src/views-default/pages/user-profile/teams'
import Profile from 'src/views-default/pages/user-profile/profile'
import Projects from 'src/views-default/pages/user-profile/projects'
import Connections from 'src/views-default/pages/user-profile/connections'
import UserProfileHeader from 'src/views-default/pages/user-profile/UserProfileHeader'
