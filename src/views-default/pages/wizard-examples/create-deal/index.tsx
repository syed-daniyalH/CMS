...
// ** Step Components
import StepDealType from 'src/views-default/pages/wizard-examples/create-deal/StepDealType'
import StepReview from 'src/views-default/pages/wizard-examples/create-deal/StepReview'
import StepDealUsage from 'src/views-default/pages/wizard-examples/create-deal/StepDealUsage'
import StepDealDetails from 'src/views-default/pages/wizard-examples/create-deal/StepDealDetails'
