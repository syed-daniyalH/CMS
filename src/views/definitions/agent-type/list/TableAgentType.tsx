...
import {getData, AgentTypeSearchParams} from "src/store/definitions/agent-type";
import {decodeParameters, encodeParameters} from "src/core/utils/encrypted-params";
import {useTranslation} from "react-i18next";
import AgentTypeTableToolbar from "./AgentTypeTableToolbar";
...
const TableAgentType = ({toggleForm}: any) => {
  ...
  // ** States
  const [searchData, setSearchData] = useState<AgentTypeSearchParams>({PageNo: 1, PageSize: 50})
  ...
  return (
    <Box sx={{flexGrow: 1}}>
      ...
      <DataGrid
        ...
        slots={{toolbar: AgentTypeTableToolbar}}
