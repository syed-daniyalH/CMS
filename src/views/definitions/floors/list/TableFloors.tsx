...
import {getData, FloorsSearchParams} from "src/store/definitions/floors";
import {decodeParameters, encodeParameters} from "src/core/utils/encrypted-params";
import {useTranslation} from "react-i18next";
import FloorsTableToolbar from "./FloorsTableToolbar";
...
const TableFloors = ({toggleForm}: any) => {
  ...
  // ** States
  const [searchData, setSearchData] = useState<FloorsSearchParams>({PageNo: 1, PageSize: 50})
  ...
  return (
    <Box sx={{flexGrow: 1}}>
      ...
      <DataGrid
        ...
        slots={{toolbar: FloorsTableToolbar}}
