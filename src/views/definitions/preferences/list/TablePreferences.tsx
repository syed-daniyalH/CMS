...
const TablePreferences = ({toggleForm}: any) => {
  ...
  // ** States
  const [searchData, setSearchData] = useState<PreferencesSearchParams>({PageNo: 1, PageSize: 50})
  ...
  return (
    <Box sx={{flexGrow: 1}}>
      ...
      <DataGrid
        ...
        slots={{toolbar: PreferencesTableToolbar}}
