...
import {getData, PropStatusSearchParams} from "src/store/definitions/prop-status";
import {decodeParameters, encodeParameters} from "src/@core/utils/encrypted-params";
import {useTranslation} from "react-i18next";
import PropStatusTableToolbar from "./PropStatusTableToolbar";
...
const TablePropStatus = ({toggleForm}: any) => {
  ...
  // ** States
  const [searchData, setSearchData] = useState<PropStatusSearchParams>({PageNo: 1, PageSize: 50})
  ...
  return (
    <Box sx={{flexGrow: 1}}>
      ...
      <DataGrid
        ...
        slots={{toolbar: PropStatusTableToolbar}}
...
export default TablePropStatus
