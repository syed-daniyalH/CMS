...
const AgentsTableActions = (props: Props) => {
      ...
      <Box sx={{display: 'flex', alignItems: 'center'}}>
        {
          ...
          <Link href={`/inventory-operations/agents/edit-agents/${encodeParameters({recno: props.selectionModel[0]})}`}>
...
export default AgentsTableActions
