...
const CustomersTableActions = (props: Props) => {
      ...
      <Box sx={{display: 'flex', alignItems: 'center'}}>
        {
          ...
          <Link href={`/inventory-operations/customers/edit-customer/${encodeParameters({recno: props.selectionModel[0]})}`}>
...
export default CustomersTableActions
