...
const PropertiesTableActions = (props: Props) => {
    ...
    >
      <Box sx={{display: 'flex', alignItems: 'center'}}>

        {
          ...
          <Link href={`/inventory-operations/property/edit-property/${encodeParameters({recno: props.selectionModel[0]})}`}>
...
export default PropertiesTableActions
