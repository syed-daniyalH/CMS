...
const SaleAgreementsTableActions = (props: Props) => {
    ...
    >
      <Box sx={{display: 'flex', alignItems: 'center'}}>

        {
          ...
          <Link href={`/inventory-operations/sale-agreements/edit-sales-agreement/${encodeParameters({recno: props.selectionModel[0]})}`}>
...
export default SaleAgreementsTableActions
