...
const ReceiptListFilter = ({queries,state, setState,open}:Props) => {
    ...
    return (
        <DatePickerWrapper>
            <Grid container spacing={4}>
              ...
              <Grid item lg={6} md={6} xs={12} sm={12}>
                  <CustomerSelector selected_value={state.floorId??null} handleChange={handleCustomer} props={{sx: {mb: 0},  }} />
            </Grid>
...
export default ReceiptListFilter
