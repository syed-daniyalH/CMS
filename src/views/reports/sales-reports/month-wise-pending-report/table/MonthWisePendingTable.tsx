...
const MonthWisePendingTable = ({filters,state, data,queries, totalRows, paginationModel, setPaginationModel, selected_columns}:any) => {
...
export default MonthWisePendingTable;
