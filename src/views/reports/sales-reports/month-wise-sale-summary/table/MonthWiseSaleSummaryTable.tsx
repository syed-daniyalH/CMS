...
const MonthWiseSaleSummaryTable = ({filters,state, data,queries, totalRows, paginationModel, setPaginationModel, selected_columns}:any) => {
...
export default MonthWiseSaleSummaryTable;
