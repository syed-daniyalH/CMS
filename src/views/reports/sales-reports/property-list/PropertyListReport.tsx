...
// ** Custom imports
import PropertyListTable from "./table/PropertyListTable";
...
const PropertyListReport = ({filters,state, queries, data, totalRows, paginationModel, setPaginationModel, selected_columns, sumData,updateQueries,setState,handleReset}: Props) => {
      ...
      <Card sx={{mt: '10px', height: `calc(100vh  - 135px)`, overflow: 'hidden'}}>
        ...
        <Stack direction='row' spacing={2} sx={{p:2}}>
          ...
          {Object.keys(filters).length > 0  && filters?.name !== "All" &&  (
            ...
            <PropertyListTable filters={filters} sumData={sumData} queries={queries} selected_columns={selected_columns} state={state} data={data} totalRows={totalRows} paginationModel={paginationModel} setPaginationModel={setPaginationModel}   />
