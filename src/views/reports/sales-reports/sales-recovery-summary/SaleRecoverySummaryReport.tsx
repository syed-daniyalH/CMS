...
// ** Custom imports
import SaleRecoverySummaryTable from "./table/SaleRecoverySummaryTable";
...
const SaleRecoverySummaryReport = ({clearAll,filters,state, queries, data, totalRows, paginationModel, setPaginationModel, selected_columns, sumData}: Props) => {
    ...
    return (
      <Card sx={{mt: '10px', height: `calc(100vh  - 135px)`, overflow: 'hidden'}}>
            ...
            <SaleRecoverySummaryTable filters={filters} sumData={sumData} queries={queries} selected_columns={selected_columns} state={state} data={data} totalRows={totalRows} paginationModel={paginationModel} setPaginationModel={setPaginationModel}   />
...
export default SaleRecoverySummaryReport
