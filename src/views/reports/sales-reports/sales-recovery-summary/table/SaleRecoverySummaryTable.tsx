...
const SaleRecoverySummaryTable = ({filters,state, sumData, data,queries, totalRows, paginationModel, setPaginationModel, selected_columns}:any) => {


  const {t} = useTranslation();

    const sumRow = { ...sumData[0], propertyNo: -100, name: t("Total"), clickable: false , sortNo:1};
...
export default SaleRecoverySummaryTable;
