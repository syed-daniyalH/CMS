...
// ** Custom imports
import SaleSummaryTable from "./table/SaleSummaryTable";
...
const SaleSummaryReport = ({clearAll,filters,state, queries, data, totalRows, paginationModel, setPaginationModel, selected_columns, sumData}: Props) => {
    ...
    return (
      <Card sx={{mt: '10px', height: `calc(100vh  - 135px)`, overflow: 'hidden'}}>
            ...
            <SaleSummaryTable filters={filters} sumData={sumData} queries={queries} selected_columns={selected_columns} state={state} data={data} totalRows={totalRows} paginationModel={paginationModel} setPaginationModel={setPaginationModel}   />
