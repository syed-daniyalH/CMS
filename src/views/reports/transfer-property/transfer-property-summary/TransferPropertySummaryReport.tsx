...
// ** Custom imports
import TransferPropertySummaryTable from "./table/TransferPropertySummaryTable";
...
const TransferPropertySummaryReport = ({clearAll,filters,state, queries, data, totalRows, paginationModel, setPaginationModel, selected_columns,setState,updateQueries,handleReset}: any) => {
  ...
  useEffect(()=>{
    ...
    return (
      <Card sx={{mt: '10px', height: `calc(100vh  - 135px)`, overflow: 'hidden'}}>
        ...
        <TransferPropertySummaryTable filters={filters} queries={queries} selected_columns={selected_columns} state={state} data={data} totalRows={totalRows} paginationModel={paginationModel} setPaginationModel={setPaginationModel}   />
...
export default TransferPropertySummaryReport
