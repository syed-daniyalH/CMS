...
import { TagSearchParams, getData } from 'src/store/settings/tags'
import CustomChip from 'src/@core/components/mui/chip'
import type { TagSchema } from './TagFormDrawer'

const columns = (toggleForm: (row: TagSchema) => void): GridColDef[] => [
  {
    flex: 0.2,
    minWidth: 180,
    field: 'name',
...
const TagTable = ({ toggleForm }: { toggleForm: (row?: TagSchema | null) => void }) => {
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      ...
      <DataGrid
        ...
        columns={columns((row: TagSchema) => toggleForm(row))}
